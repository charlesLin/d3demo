...
var url = "http://chartapi.finance.yahoo.com/instrument/1.0/2330.tw/chartdata;type=quote;range=1y/json/?callback=myCallBack";

var data;

function myCallBack(_data) {
  data = _data;
}

function render(stock, color) {
  d3.text(url, (error, tdata) => {
    eval(tdata);
